...
from dsf.hankel.hankel_transform_fftlog import hankel_projected_order_2, hankel_spherical_order_0
...
def test_hankel_spherical_order_0_matches_ccl():
    ...
    xi_dsf = hankel_spherical_order_0(
        k_arr, cosmo.nonlin_matter_power(k_arr, 1 / (1 + z)), use_offset=False
    )(r_arr)
